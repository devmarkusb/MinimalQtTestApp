...
$dev_sdk_path/qt_linux/$qt_version/android_arm64_v8a/bin/qt-cmake \
    ...
    -DCMAKE_PREFIX_PATH=$dev_sdk_path/qt_linux/$qt_version/gcc_64 \
    -DQT_ANDROID_SIGN_AAB=True \
    -DQT_ANDROID_PACKAGE_NAME=org.qtproject.example.MinimalQtTestApp \
    -DQT_ANDROID_APP_NAME=MinimalQtTestApp \
    -DQT_ANDROID_VERSION_CODE=4 \
    -DQT_ANDROID_VERSION_NAME=1.0 \
    -S .. -B . \
    -G Ninja
